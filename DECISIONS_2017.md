...
| N2 | window + Cleaning-2 notebook (new) | T2 | To create: read T1 (already window-restricted by N1), compute tags C2–C7, add Level-1 constructed columns (E2, E3, E5, E6) incl. switch tags (§D), save T2. E4 is NOT built here: it needs the fare table (E1) and `ever_*` (E12), both built in N3 (decided 2026-08-31) |
